  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.container_main}>
        <Image
          source={require('../assets/images/happy_mascot.png')}
          style={styles.logo}
        />
        ...
        <Text style={styles.description}>
        Our app makes it easy to divide costs, track spending, and settle up quickly and fairly. Whether you're splitting rent with roommates, sharing vacation costs, or managing group gifts, our intuitive platform ensures everyone pays their fair share.        </Text>
        <Text style={styles.description}>
