...
import { View, Text, TextInput, Button, FlatList, StyleSheet, TouchableOpacity, SafeAreaView, Platform, StatusBar, ScrollView, Modal, Alert } from 'react-native';
import { useFocusEffect } from '@react-navigation/native';
import { AntDesign, MaterialIcons } from '@expo/vector-icons'; // Add this import
import api from '../api';
import HeaderBar from '../components/HeaderBar'; // Make sure this path is correct
import userGroups from '../src/functions/fetchUserGroups';

const ReceiptScanChooseGroup = ({ navigation, route }) => {
  ...
  const handleGroupPress = (groupId) => {
    const fetchGroupDetails = async () => {
      try {
        ...
        navigation.navigate('ReceiptScanAddExpense', { groupdata: groupData, data });
      } catch (error) {
  ...
  const toggleSort = () => {
    setSortBy((prevSortBy) => (prevSortBy === 'default' ? 'group_id' : 'default'));
  };
...
export default ReceiptScanChooseGroup;
